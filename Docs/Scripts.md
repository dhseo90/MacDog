...
| `script/verify_v160_codex_recovery_planner_contract.sh --self-test` | v1.6.0 Codex Recovery Planner 계약 자체검증 | live app-server, GUI 앱, 설치, LaunchAgent, push 없이 reset schedule/session plan source, 문서 경계, focused Swift tests를 실행합니다. |
