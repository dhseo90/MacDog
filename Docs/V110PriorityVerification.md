...
1. 요일별 주간 잔여량 그래프 마무리와 실제 UI 검수
   ...
   - 현재 증거: `Docs/V110ManualEvidence.md`의 `weekly_usage_graph` 확인됨
   - 남은 증거: 없음
...
2. 깨끗한 drag-and-drop DMG 설치 검수
   ...
   - 현재 증거: `Docs/V110ManualEvidence.md`의 `clean_drag_and_drop_dmg` 확인됨
   - 남은 증거: 없음
...
3. 앱 내부 helper 버튼 실제 클릭 검수
   ...
   - 현재 증거: `Docs/V110ManualEvidence.md`의 `helper_button_click` 확인됨
   - 남은 증거: 없음
...
4. 플로팅 펫 실제 동작 검수
   ...
   - 현재 증거: `Docs/V110ManualEvidence.md`의 `floating_pet_manual_ui` 확인됨
   - 남은 증거: 없음
...
5. 런타임 리소스 최적화 검토
   ...
   - 현재 증거: `Docs/V110ManualEvidence.md`의 `runtime_resource_review` 확인됨
   - 남은 증거: 없음
...
6. unsigned GitHub Actions release workflow 실제 실행 검증
   ...
   - 현재 증거: `Docs/V110ManualEvidence.md`의 `unsigned_release_workflow_run` 확인됨
   - 남은 증거: 없음
