...
- 2026-06-02 unsigned draft release workflow run URL [https://github.com/dhseo90/MacDog/actions/runs/26815189716](https://github.com/dhseo90/MacDog/actions/runs/26815189716) success exercised the draft release workflow path. Final v1.1.0 release was retargeted to main head e84b9873d0d5b61775c06e761e219bb452da27df, assets were clobber-replaced with the latest candidate, and GitHub release [https://github.com/dhseo90/MacDog/releases/tag/v1.1.0](https://github.com/dhseo90/MacDog/releases/tag/v1.1.0) was published; tagName v1.1.0, isDraft=false, isPrerelease=true, targetCommitish=e84b9873d0d5b61775c06e761e219bb452da27df, assets MacDog-1.1.0.dmg and MacDog-1.1.0.dmg.sha256 uploaded with /download/v1.1.0 URLs. Downloaded published release assets to /tmp/macdog-v110-published.9CRTcn; shasum -a 256 -c passed; hdiutil verify passed.
- 2026-06-03 문서/이미지 audit 중 local HEAD, origin/main, local tag v1.1.0, GitHub release targetCommitish가 모두 e84b9873d0d5b61775c06e761e219bb452da27df임을 재확인했습니다. GitHub release 상태는 tagName=v1.1.0, isDraft=false, isPrerelease=true입니다.
