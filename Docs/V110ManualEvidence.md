...
- 2026-06-02 unsigned draft release workflow run URL [https://github.com/dhseo90/MacDog/actions/runs/26815189716](https://github.com/dhseo90/MacDog/actions/runs/26815189716) success exercised the draft release workflow path. Final v1.1.0 release was retargeted to the then-current main release head, assets were clobber-replaced with the latest candidate, and GitHub release [https://github.com/dhseo90/MacDog/releases/tag/v1.1.0](https://github.com/dhseo90/MacDog/releases/tag/v1.1.0) was published; tagName v1.1.0, isDraft=false, assets MacDog-1.1.0.dmg and MacDog-1.1.0.dmg.sha256 uploaded with /download/v1.1.0 URLs. Downloaded published release assets to /tmp/macdog-v110-published.9CRTcn; shasum -a 256 -c passed; hdiutil verify passed.
- 2026-06-03 문서/이미지 audit 중 `git rev-parse HEAD`, `git rev-parse origin/main`, `git rev-parse v1.1.0`, `gh release view v1.1.0 --json targetCommitish`로 local HEAD, origin/main, local tag v1.1.0, GitHub release targetCommitish가 일치함을 재확인했습니다.
- 2026-06-03 `gh release edit v1.1.0 --prerelease=false --latest`로 v1.1.0 GitHub Release를 일반 release로 정정했습니다. `gh release view v1.1.0 --json isDraft,isPrerelease,tagName,targetCommitish,url,assets` 결과 tagName=v1.1.0, isDraft=false, isPrerelease=false, targetCommitish=7ffcd63f2c53686de8dc33ebafc343b42e6b123b, assets MacDog-1.1.0.dmg and MacDog-1.1.0.dmg.sha256 uploaded.
