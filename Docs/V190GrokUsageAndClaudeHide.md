...
상태: 로드맵만 작성 / 구현·live spike·문서 정렬·릴리즈 미착수
작성일: 2026-08-15
대상 버전: `1.9.0`
기준 브랜치: `v1.9.0`
...
1. Step 1 — 이 문서. 현재 묶음.
2. Step 2~4 — 원천 spike와 계약. 구현 PR 전에 닫는다.
3. Step 5~7 — Claude hide와 3분기 routing.
4. Step 8~9 — Grok cache와 writer.
5. Step 10~13 — UI, 러너, 알림, 테스트.
