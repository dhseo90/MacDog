...
- release staging의 `Install Privileged Helper.command`는 관리자 승인 전에 helper 용도와 변경할 system 위치를 안내한다.
...
- release staging의 `Uninstall Privileged Helper.command`는 관리자 승인 전에 제거할 system 위치를 안내하고 optional helper만 제거한다.
