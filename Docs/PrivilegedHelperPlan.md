...
- `verify_manual_ui_prerequisites.sh`는 메뉴바 popover, 플로팅 펫, helper 버튼, WidgetKit 수동 검수 전에 앱 bundle, 캐릭터 asset, widget readiness, widget cache fixture self-test, helper preflight, Shortcuts read-only probe, 설치본 freshness를 묶어 확인한다.
