...
12. 공개 배포는 GitHub Environment `public-stable-release` 승인을 둔 `Stable Release` workflow에서 `SIGNED-STABLE` 확인 입력과 Apple signing/notarization secrets가 모두 있을 때만 실행합니다.
