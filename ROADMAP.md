...
| 10 | MacDog 시스템 유틸리티 모듈 | RunCat식 상세 Mac 상태/배터리/잠자기 방지 4대 세션 UI/자동 trigger 1차 확장/closed-display 조사/Charge Limit 연구 스파이크와 설정 연결 구현 완료 | trigger 세부 설정, Shortcuts 검증 |
...
5. Charge Limit Shortcuts 액션 실기기 검증
