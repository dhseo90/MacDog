...
| Release Packaging | DMG, checksum, GitHub Release 절차, release smoke | v1.4.0 replacement DMG 생성/검증 완료, remote tag/asset 교체 대기 | published DMG 기준 재다운로드, Finder 설치, final-state smoke |
| v1.3.0 | 알림 중심 사용량 인지와 탭별 UI 개선 | 릴리즈 완료 | 후속 이슈 없음 |
| v1.4.0 | Usage Intelligence: 과거 사용량, 예측, 오버레이, export | P0-P2 구현 완료, 자동 검증/CI/replacement DMG 검증 완료 | published DMG 설치 후 지난/비교 UI smoke와 release final-state |
