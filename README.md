...
- 일반 잠자기 방지 모듈: IOKit power assertion으로 시스템 idle sleep 방지
...
- CLI MVP, shared cache, macOS 메뉴바 앱, Codex Pup 러너, 데스크톱 플로팅 펫 MVP, Mac 상태/배터리 읽기 전용 1차 모듈, 일반 잠자기 방지 모듈 구현 완료
