...
require_text_match 'CodexUsageCacheStore\.defaultSharedFileURL\(\)' "$MENU_BAR_CONTROLLER" "menu bar app reads the WidgetKit shared cache"
require_text_match 'CodexUsageCacheStore\.defaultMirroredFileURLs\(\)' "$MENU_BAR_CONTROLLER" "menu bar app writes both default and shared caches"
