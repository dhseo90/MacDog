...
require_contains "$install_output" "Cache request timeout: 15 seconds"
require_contains "$install_output" "Cache prime timeout: 22 seconds"
...
require_contains "$uninstall_output" "Would bootout: gui/$(id -u) $HOME/Library/LaunchAgents/com.dhseo.macdog.grok-usage-cache.plist"
...
require_contains "$uninstall_output" "Would remove: $HOME/Library/LaunchAgents/com.dhseo.macdog.grok-usage-cache.plist"
...
require_contains "$uninstall_output" "Would remove Grok usage cache file: $HOME/Library/Application Support/MacDog/grok-usage.json"
require_contains "$uninstall_output" "Would remove Grok usage history file: $HOME/Library/Application Support/MacDog/grok-usage-history.json"
require_contains "$uninstall_output" "Would remove Grok usage lock file: $HOME/Library/Application Support/MacDog/grok-usage.lock"
