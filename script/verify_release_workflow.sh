...
require_draft_match 'DRAFT_RELEASE_LOOKUP_ATTEMPTS=10'
require_draft_match 'DRAFT_RELEASE_LOOKUP_DELAY_SECONDS=2'
require_draft_match 'releases\?per_page=100'
require_draft_match '\[\.id, \.html_url\] \| @tsv'
require_draft_match 'Created draft release is not visible yet; retrying readback'
require_draft_match 'sleep "\$DRAFT_RELEASE_LOOKUP_DELAY_SECONDS"'
