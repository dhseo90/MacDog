...
require_file "script/configure_github_public_repo_settings.sh"
...
require_text ".github/workflows/ci.yml" "MACDOG_APP_VERSION: 9.9.9"
...
require_text "script/configure_github_public_repo_settings.sh" "MACDOG_CONFIRM_PUBLIC=MAKE-MACDOG-PUBLIC"
require_text "script/configure_github_public_repo_settings.sh" "first_time_contributors"
require_text "script/configure_github_public_repo_settings.sh" "automated-security-fixes"
require_text "script/configure_github_public_repo_settings.sh" "vulnerability-alerts"
