...
require_text 'CodexUsageSummaryInline' "Sources/MacDog/Popover/CodexUsagePanel.swift" "Codex risk and notification summary UI"
require_text 'codex-usage-risk-notification-summary' "Sources/MacDog/Popover/CodexUsagePanel.swift" "Codex risk summary accessibility identifier"
...
require_text 'CodexUsageSummaryInline' "Tests/MacDogTests/PopoverScreenshotRendererTests.swift" "risk summary regression test"
